      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Relocate from Los Angeles to Las Vegas
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Trade LA traffic for Las Vegas convenience. Enjoy no state income
            tax, affordable housing, shorter commutes, and a better quality of
            life.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Why Move from Los Angeles to Las Vegas?
          </h2>
        ...
        <div className="mt-12">
          <RealScoutListingsWidget
            ...
            subtitle="Explore homes in Las Vegas and Summerlin perfect for LA relocations. Find properties that match your lifestyle and budget."
          />
        </div>
      </div>
    </div>
