      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Relocate from San Francisco to Las Vegas
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Escape SF's high cost of living for Las Vegas affordability. Enjoy
            no state income tax, significantly lower housing costs, and more
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Why Move from San Francisco to Las Vegas?
          </h2>
          <p className="text-gray-700 mb-4">
            Many San Francisco residents are discovering the benefits of
            relocating to Las Vegas: no state income tax, significantly lower
            cost of living, affordable housing (get much more for your money),
            and a thriving economy. Contact Dr. Jan Duffy to learn more about
            making Las Vegas your new home.
          </p>
          <p className="text-gray-700">
            I specialize in helping SF families relocate to Las Vegas and
        ...
        <div className="mt-12">
          <RealScoutListingsWidget
            ...
            subtitle="Explore homes in Las Vegas and Summerlin perfect for San Francisco relocations. Find properties that match your lifestyle and budget."
          />
        </div>
      </div>
    </div>
